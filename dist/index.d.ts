...
type FeaturableAPIResponseV1 = FeaturableAPIResponseV1Success | FeaturableAPIResponseV1Error;
declare const FeaturableAPIResponseV1: {};
...
type FeaturableAPIResponseV2 = FeaturableAPIResponseV2Success | FeaturableAPIResponseV2Error;
declare const FeaturableAPIResponseV2: {};
type FeaturableAPIResponse = FeaturableAPIResponseV1 | FeaturableAPIResponseV2;
declare const FeaturableAPIResponse: {};
type WidgetVersion = 'v1' | 'v2';
...
type ReviewCardProps = ReviewCardBaseProps & ReviewCardCSSProps;
...
export { FeaturableAPIResponse, GoogleReview as ReactGoogleReview, ReactGoogleReviews, ReviewCard, type ReviewCardProps, dangerouslyFetchPlaceReviews };
